			...
			?>
	            ...
	            <fieldset>
					...
					<table id='bsc-brand-colors-editor' aria-hidden='###' class='form-table'>
					  <tbody>
						<tr><td id='bsc-brand-colors-toolbar' role='toolbar'>
						  <button id='bsc-brand-colors-add-button' type='submit' tabindex='8' name='bsc-action' value='add' class='button' aria-controls='bsc-brand-colors' accesskey='###'>Add Color</button>
						</td></tr>
						<tr><td id='kt_colors' data-empty='" . esc_attr__('Palette is empty', 'bsc-brand-colors') . "'>picker here</td></tr>
					  </tbody>
					</table>
	            </fieldset>
